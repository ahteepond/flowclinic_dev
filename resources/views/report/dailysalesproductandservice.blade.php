...
@section('script')
    ...
    var dataTable = $('#datatableinfo').DataTable({
        ...
        columns: [
            ...
            { title: "ยอดที่ชำระแล้ว", data: 'price_paid', name: 'price_paid' },
            { title: "ยอดค้างชำระ", data: 'price_balance', name: 'price_balance' },
            { title: "ยอดคำสั่งซื้อ", data: 'price_nettotal', name: 'price_nettotal' },
