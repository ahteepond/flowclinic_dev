...
@section('title','วิธีการชำระเงิน') {{-- Title --}}
                        ...
                        <div class="card">
                            <div class="card-header row">
                                <div class="col-8 text-start">
                                    <h3 class="card-title">รายการวิธีการชำระเงิน</h3>
                                </div>
                                <div class="col-4 text-end">
                                    <a href="{{ route('paymenttype.new') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus me-2"></i>New</a>
                                </div>
